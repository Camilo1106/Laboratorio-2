    ...
    <div className="border bg-card text-card-foreground p-3 shadow-sm md:rounded-lg flex justify-between items-center top-0 sticky z-50">
      ...
      <div className="space-x-3 items-center">
        ...
        >
          ...
          <span className="hidden md:block ml-2">Proyectoss</span>
        </Button>
        <Button
        ...
        >
          ...
          <span className="hidden md:block ml-2">Mini-proyectos</span>
        </Button>
        <Button
        ...
        >
          ...
          <span className="hidden md:block ml-2">Contacto</span>
        </Button>
      </div>
    </div>
  );
